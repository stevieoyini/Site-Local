  ...
  <html lang="fr">
    ...
    <body>
      ...
      <section>
        ...
        <h3>Commentaires et Sujets</h3>
        <p>
          Quand vous laissez un commentaire ou un sujet sur Grafikart, les
          données inscrites dans le formulaire, mais aussi votre adresse IP et
          l’agent utilisateur de votre navigateur sont collectés pour nous aider
          à la détection des commentaires indésirables.
        </p>
        <p>
        ...
        <p>
          Certains articles de ce site peuvent inclure des contenus intégrés
          (par exemple des vidéos, images, articles…). Le contenu intégré depuis
        ...
        <p>
          ...
          cookies, embarquer des outils de suivi tiers, suivre vos interactions
        ...
        <p>
          fin d'analyser le traffic du site (nombre de visites, pages les plus
          consultées...) nous n'utilisons pas de service tiers mais un service
          auto hébergé basé sur Fathom. Les données sont anonymisées et ne
          permettent pas d'identifier le comportement individuel d'un
          utilisateur mais plutôt une tendance générale (nombre de visites sur
          le site et le nombre de visites par page seulement).
        </p>
        ...
        <p>
          ...
          site, vous pouvez demander la suppression des données personnelles
          vous concernant. Cela ne prend pas en compte les données stockées à
          des fins administratives, légales ou pour des raisons de sécurité.<br />
          ...
          en cliquant sur le bouton supprimé.<br />
          Si vous avez posté un commentaire sans être connecté vous pouvez me
          contacter pour demander la suppression de ce dernier.
        </p>
        ...
        <p>
          Afin que les données à caractère personnel que nous recueillons ne
          soient ni perdues, ni divulguées par des tiers non autorisés, nous
          avons mis en place les mesures nécessaires (pare feu, base de données
          non accessible à distance...) proportionnellement à la sensibilité des
          données stockées.
        </p>
